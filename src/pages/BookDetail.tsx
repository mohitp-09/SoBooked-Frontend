...
const BookDetail = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-[64px]">
      {/* Back Button Container - Fixed for mobile */}
      <div className="fixed top-[64px] left-0 right-0 z-50 bg-gray-50/95 backdrop-blur-sm border-b border-gray-100 shadow-sm">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <button
            onClick={() => navigate('/')}
            className="flex items-center gap-2 text-blue-600 hover:text-blue-700 transition-colors py-3"
          >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pt-16">
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8 p-6 sm:p-8">
            {/* Left Column - Image */}
            ...
            <div className="md:col-span-3 flex flex-col">
              ...
              <div className="mb-6">
                <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">{book.name}</h1>
              ...
              <div className="bg-white rounded-xl border border-gray-200 p-4 sm:p-6">
                ...
                <div className="space-y-4">
                  <button
                    ...
                    className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-blue-600 text-white rounded-xl font-medium flex items-center justify-between hover:bg-blue-700 transition-colors shadow-sm hover:shadow group"
                  >
                  ...
                  {book.availableForRent ? (
                    <button
                      ...
                      className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-white border-2 border-blue-600 text-blue-600 rounded-xl font-medium flex items-center justify-between hover:bg-blue-50 transition-colors group"
                    >
                      <span className="flex items-center gap-2">
                    ...
                    <button
                      className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-gray-50 border-2 border-gray-200 text-gray-400 rounded-xl font-medium flex items-center justify-center gap-2 cursor-not-allowed"
                    >
